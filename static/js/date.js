...
Date.getDaysInYear=function(year){return Date.isLeapYear(year)?366:365;};
...
return this;};Date.prototype.clearTime=function(){this.setHours(0);this.setMinutes(0);this.setSeconds(0);this.setMilliseconds(0);return this;};Date.prototype.isLeapYear=function(){var y=this.getFullYear();return(((y%4===0)&&(y%100!==0))||(y%400===0));};Date.prototype.isWeekday=function(){return!(this.is().sat()||this.is().sun());};
Date.prototype.getDaysInMonth=function(){return Date.getDaysInMonth(this.getFullYear(),this.getMonth());};
Date.prototype.getDaysInYear=function(){return Date.getDaysInYear(this.getFullYear());};
...
Date.prototype.moveToFirstDayOfYear=function(){return this.set({day:1, month:0});};
Date.prototype.moveToLastDayOfYear=function(){return this.set({day:Date.getDaysInMonth(this.getFullYear(),11), month:11});};
