...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_ROOT, 'db', 'development.sqlite3'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'm)s=2t(764yp)!o#38qvby$k9m!@vis*fyr96^!pp2)=s6if)r'
